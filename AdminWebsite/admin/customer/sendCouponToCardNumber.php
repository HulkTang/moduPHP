...
<form action="../doAdminAction.php" method="post">
    <input type="hidden" name="act" value="sendCouponToCardNumber" >
    <table width="70%" border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
        <tr>
            <td align="right">卡号</td>
            <td><input type="text" name="coupon_card_number" id="coupon_card_number" value="<?php echo $cardNumber;?>" placeholder="请输入卡号" onblur="getCardNumberVerified()"/></td>
        </tr>
        <tr>
